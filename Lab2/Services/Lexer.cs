...
public class Lexer
{
    ...
    private static LexemeCategory GetCategory(TokenType type)
    {
        return type switch
        {
            TokenType.Not or TokenType.And or TokenType.Or or TokenType.Output or TokenType.Do or TokenType.Until or TokenType.Loop => LexemeCategory.Keyword,
    ...
    private void AddToken(TokenType type, string lexeme, int pos)
    {
        ...
        {
            if (_pLast != null) _pLast.Next = token;
            _pLast = token;
        }
    }
    ...
    public Token? LexAnalysis(string text)
    {
        ...
        while (pos < length)
        {
            ...
            if (char.IsLetter(currentChar))
            {
                ...
                var type = lexeme.ToLower() switch
                {
                    "not" => TokenType.Not,
                    "and" => TokenType.And,
                    "or" => TokenType.Or,
